...
const LandingPage = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-[#09090b] text-zinc-100 selection:bg-zinc-800 selection:text-white font-sans antialiased"
    >
      ...
      <header className="sticky top-0 z-50 bg-[#09090b]/90 backdrop-blur-md border-b border-zinc-800/80">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              to="/login"
              className="text-xs font-semibold text-zinc-900 bg-white hover:bg-zinc-200 px-3.5 py-1.5 rounded-lg transition-colors flex items-center gap-1.5"
            >
      ...
      <section className="pt-16 pb-16 md:pt-24 md:pb-24 px-4 sm:px-6 max-w-5xl mx-auto text-center">
        <motion.div variants={staggerContainer} className="space-y-6">
          ...
          <motion.div variants={fadeUp} className="flex flex-wrap items-center justify-center gap-3 pt-2">
            <Link
              to="/login"
              className="px-5 py-2.5 text-xs font-semibold text-zinc-900 bg-white hover:bg-zinc-200 rounded-lg transition-colors flex items-center gap-2"
            >
        ...
        {/* Minimal Terminal Mockup Component (No Images!) */}
      ...
      <section id="features" className="py-20 border-t border-zinc-800/80 px-4 sm:px-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="p-5 rounded-xl border border-zinc-800/80 bg-zinc-900/20 hover:border-zinc-700 transition-colors">
      ...
      <section id="how-it-works" className="py-20 border-t border-zinc-800/80 px-4 sm:px-6 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-xl border border-zinc-800 bg-zinc-900/30 relative">
      ...
      <section className="py-16 px-4 sm:px-6 max-w-5xl mx-auto border-t border-zinc-800/80">
        <div className="p-8 sm:p-12 rounded-2xl border border-zinc-800 bg-zinc-900/50 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            to="/login"
            className="px-5 py-2.5 text-xs font-semibold text-zinc-900 bg-white hover:bg-zinc-200 rounded-lg transition-colors flex items-center gap-1.5 shrink-0"
          >
            Get Started <ArrowRight className="w-3.5 h-3.5" />
          </Link>
        </div>
